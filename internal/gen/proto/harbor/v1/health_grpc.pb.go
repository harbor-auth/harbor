...
const (
	HealthService_Check_FullMethodName = "/harbor.v1.HealthService/Check"
)
...
//
// HealthService reports whether an internal component is serving.
type HealthServiceClient interface {
	// Check returns the current serving status of the component.
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "harbor.v1.HealthService",
	...
	Metadata: "harbor/v1/health.proto",
}
