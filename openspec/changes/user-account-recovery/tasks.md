...
- [ ] **Migration prefix `0015` is reserved** for this change
  ...
  user-audit-trail 0013, email-relay-service 0014).
...
- [ ] `internal/identity/recovery.go`: generate N single-use codes; salted
...
- [ ] Recovery ceremony: accept a valid unused code **or** a fallback
  authenticator → re-authenticated session; require a fresh passkey before
